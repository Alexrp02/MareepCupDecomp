...
with open("../src/data/pokemon/species_info/gen_1.h", "r", encoding="utf-8") as file:
...
with open("test.h", "w", encoding="utf-8") as file:
    file.writelines(new_lines)

print("Abilities successfully randomized in your_file.h!")