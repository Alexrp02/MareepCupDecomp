...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = {ABILITY_SUCTION_CUPS, ABILITY_POISON_POINT, ABILITY_HUNGER_SWITCH}
    ...
    [SPECIES_IVYSAUR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_GRASS },
        .abilities = {ABILITY_SIMPLE, ABILITY_INTREPID_SWORD, ABILITY_STALWART}
        .bodyColor = BODY_COLOR_GREEN,
...
#define VENUSAUR_MISC_INFO                                                  \
    ...
    [SPECIES_VENUSAUR] =
    {
        ...
        .baseSpDefense = 100,
        .expYield = 236,
        .abilities = {ABILITY_PSYCHIC_SURGE, ABILITY_FRIEND_GUARD, ABILITY_SUPER_LUCK}
        .cryId = CRY_VENUSAUR,
        .height = 20,
        .weight = 1000,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_VENUSAUR_MEGA] =
    {
        ...
        .baseSpDefense = 120,
        .expYield = 281,
        .abilities = {ABILITY_DANCER, ABILITY_HYPER_CUTTER, ABILITY_STALL}
    ...
    [SPECIES_VENUSAUR_GIGANTAMAX] =
    {
        ...
        .baseSpDefense = 100,
        .expYield = 236,
        .abilities = {ABILITY_WATER_ABSORB, ABILITY_POISON_HEAL, ABILITY_MINUS}
        .cryId = CRY_VENUSAUR,
        .height = 240,
        .weight = 0,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = {ABILITY_BEADS_OF_RUIN, ABILITY_PERISH_BODY, ABILITY_MOLD_BREAKER}
    ...
    [SPECIES_CHARMELEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_DRAGON },
        .abilities = {ABILITY_SHED_SKIN, ABILITY_PICKUP, ABILITY_GRIM_NEIGH}
        .bodyColor = BODY_COLOR_RED,
...
#define CHARIZARD_MISC_INFO                                             \
    ...
    [SPECIES_CHARIZARD] =
    {
        ...
        .expYield = 240,
        .abilities = {ABILITY_PICKUP, ABILITY_PSYCHIC_SURGE, ABILITY_ICE_BODY}
        .bodyColor = BODY_COLOR_RED,
        .cryId = CRY_CHARIZARD,
        .height = 17,
        .weight = 905,
    ...
    [SPECIES_CHARIZARD_MEGA_X] =
    {
        ...
        .expYield = 285,
        .abilities = {ABILITY_MOTOR_DRIVE, ABILITY_AS_ONE_ICE_RIDER, ABILITY_HYDRATION}
    ...
    [SPECIES_CHARIZARD_MEGA_Y] =
    {
        ...
        .types = { TYPE_FIRE, TYPE_FLYING },
        .expYield = 285,
        .abilities = {ABILITY_TORRENT, ABILITY_PARENTAL_BOND, ABILITY_DRAGONS_MAW}
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_CHARIZARD_GIGANTAMAX] =
    {
        ...
        .types = { TYPE_FIRE, TYPE_FLYING },
        .expYield = 240,
        .abilities = {ABILITY_FORECAST, ABILITY_RKS_SYSTEM, ABILITY_FLOWER_GIFT}
        .bodyColor = BODY_COLOR_RED,
        .cryId = CRY_CHARIZARD,
        .height = 280,
        .weight = 0,
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .abilities = {ABILITY_MIRROR_ARMOR, ABILITY_MAGICIAN, ABILITY_TINTED_LENS}
    ...
    [SPECIES_WARTORTLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_WATER_1 },
        .abilities = {ABILITY_SAND_VEIL, ABILITY_OBLIVIOUS, ABILITY_ADAPTABILITY}
        .bodyColor = BODY_COLOR_BLUE,
...
#define BLASTOISE_MISC_INFO                                             \
    ...
    [SPECIES_BLASTOISE] =
    {
        ...
        .baseSpDefense = 105,
        .expYield = 239,
        .abilities = {ABILITY_MOXIE, ABILITY_NEUTRALIZING_GAS, ABILITY_WONDER_GUARD}
        .cryId = CRY_BLASTOISE,
        .height = 16,
        .weight = 855,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_BLASTOISE_MEGA] =
    {
        ...
        .baseSpDefense = 115,
        .expYield = 284,
        .abilities = {ABILITY_BATTLE_BOND, ABILITY_COSTAR, ABILITY_FLOWER_VEIL}
    ...
    [SPECIES_BLASTOISE_GIGANTAMAX] =
    {
        ...
        .baseSpDefense = 105,
        .expYield = 239,
        .abilities = {ABILITY_GRIM_NEIGH, ABILITY_STATIC, ABILITY_WATER_COMPACTION}
        .cryId = CRY_BLASTOISE,
        .height = 250,
        .weight = 0,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        .abilities = {ABILITY_SAP_SIPPER, ABILITY_PROTEAN, ABILITY_COMPOUND_EYES}
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = {ABILITY_PSYCHIC_SURGE, ABILITY_TERAVOLT}
        .bodyColor = BODY_COLOR_GREEN,
...
#define BUTTERFREE_MISC_INFO                                                        \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                           \
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },                              \
        .abilities = {ABILITY_INTIMIDATE, ABILITY_POISON_HEAL, ABILITY_GRIM_NEIGH}
    ...
    [SPECIES_WEEDLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = {ABILITY_WONDER_SKIN, ABILITY_POISON_HEAL, ABILITY_SHED_SKIN}
    ...
    [SPECIES_KAKUNA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = {ABILITY_OVERCOAT, ABILITY_SAP_SIPPER}
...
#define BEEDRILL_MISC_INFO                                  \
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .expYield = 178,
        .abilities = {ABILITY_DRY_SKIN, ABILITY_ROCKY_PAYLOAD, ABILITY_UNBURDEN}
        .cryId = CRY_BEEDRILL,
        .height = 10,
        .weight = 295,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_BEEDRILL_MEGA] =
    {
        ...
        .baseSpDefense = 80,
        .expYield = 223,
        .abilities = {ABILITY_MIRROR_ARMOR, ABILITY_BALL_FETCH, ABILITY_WANDERING_SPIRIT}
    ...
    [SPECIES_PIDGEY] =
    {
        ...
        .abilities = {ABILITY_MERCILESS, ABILITY_SYNCHRONIZE, ABILITY_SOLAR_POWER}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PIDGEOTTO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = {ABILITY_CLEAR_BODY, ABILITY_STEELWORKER, ABILITY_SNOW_CLOAK}
        .bodyColor = BODY_COLOR_BROWN,
...
#define PIDGEOT_MISC_INFO                                   \
    ...
    [SPECIES_PIDGEOT] =
    {
        ...
        .expYield = 216,
        .abilities = {ABILITY_STEELY_SPIRIT, ABILITY_ORICHALCUM_PULSE, ABILITY_SAND_STREAM}
        .cryId = CRY_PIDGEOT,
        .height = 15,
        .weight = 395,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_PIDGEOT_MEGA] =
    {
        ...
        .baseSpDefense = 80,
        .expYield = 261,
        .abilities = {ABILITY_LIQUID_OOZE, ABILITY_FRISK, ABILITY_PERISH_BODY}
...
#define RATICATE_MISC_INFO                  \
    ...
    [SPECIES_RATTATA] =
    {
        ...
        .abilities = {ABILITY_NEUROFORCE, ABILITY_BATTERY, ABILITY_OVERCOAT}
    ...
    [SPECIES_RATICATE] =
    {
        ...
        .baseSpDefense = 70,
        .types = { TYPE_NORMAL, TYPE_NORMAL },
        .abilities = {ABILITY_ICE_BODY, ABILITY_WONDER_GUARD, ABILITY_BEAST_BOOST}
        .bodyColor = BODY_COLOR_BROWN,
        .weight = 185,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_RATTATA_ALOLAN] =
    {
        ...
        .abilities = {ABILITY_OBLIVIOUS, ABILITY_DEFIANT, ABILITY_UNAWARE}
        .bodyColor = BODY_COLOR_BLACK,
        .height = 3,
        .weight = 38,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_RATICATE_ALOLAN] =
    {
        ...
        .types = { TYPE_DARK, TYPE_NORMAL },
        .itemRare = ITEM_PECHA_BERRY,
        .abilities = {ABILITY_BATTLE_ARMOR, ABILITY_SNOW_CLOAK, ABILITY_SHELL_ARMOR}
        .bodyColor = BODY_COLOR_BLACK,
        .weight = 255,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SPEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = {ABILITY_SCHOOLING, ABILITY_COMPETITIVE, ABILITY_PURIFYING_SALT}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_FEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = {ABILITY_STRONG_JAW, ABILITY_STALL, ABILITY_PROPELLER_TAIL}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_EKANS] =
    {
        ...
        .abilities = {ABILITY_WATER_BUBBLE, ABILITY_UNAWARE, ABILITY_LEVITATE}
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Ekans"),
        .cryId = CRY_EKANS,
    ...
    [SPECIES_ARBOK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_DRAGON },
        .abilities = {ABILITY_REGENERATOR, ABILITY_SURGE_SURFER, ABILITY_CURSED_BODY}
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Arbok"),
        .cryId = CRY_ARBOK,
...
#define PICHU_MISC_INFO                                                                 \
        ...
        .abilities = {ABILITY_DARK_AURA, ABILITY_WONDER_GUARD, ABILITY_DROUGHT}
        .bodyColor = BODY_COLOR_YELLOW,                                                 \
        .speciesName = _("Pichu"),                                                      \
        .cryId = CRY_PICHU,                                                             \
...
#define PIKACHU_MISC_INFO                                                       \
        ...
        .friendship = STANDARD_FRIENDSHIP,                                      \
        .growthRate = GROWTH_MEDIUM_FAST,                                       \
        .abilities = {ABILITY_PRANKSTER, ABILITY_DELTA_STREAM, ABILITY_EARTH_EATER}
        .bodyColor = BODY_COLOR_YELLOW,                                         \
...
#define RAICHU_MISC_INFO                                    \
    ...
    [SPECIES_RAICHU] =
    {
        ...
        .baseSpDefense = 80,
        .types = { TYPE_ELECTRIC, TYPE_ELECTRIC },
        .abilities = {ABILITY_ORICHALCUM_PULSE, ABILITY_KLUTZ, ABILITY_FUR_COAT}
        .bodyColor = BODY_COLOR_YELLOW,
        .height = 8,
        .weight = 300,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_RAICHU_ALOLAN] =
    {
        ...
        .abilities = {ABILITY_ZEN_MODE, ABILITY_BATTLE_BOND}
        .bodyColor = BODY_COLOR_BROWN,
        .isAlolanForm = TRUE,
        .height = 7,
        .weight = 210,
...
#define SANDSLASH_MISC_INFO                                 \
    ...
    [SPECIES_SANDSHREW] =
    {
        ...
        .abilities = {ABILITY_LIGHT_METAL, ABILITY_SOLID_ROCK, ABILITY_ROCKY_PAYLOAD}
        .bodyColor = BODY_COLOR_YELLOW,
        .height = 6,
        .weight = 120,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SANDSLASH] =
    {
        ...
        .baseSpDefense = 55,
        .types = { TYPE_GROUND, TYPE_GROUND },
        .abilities = {ABILITY_ILLUMINATE, ABILITY_PIXILATE, ABILITY_SCHOOLING}
        .bodyColor = BODY_COLOR_YELLOW,
        .height = 10,
        .weight = 295,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SANDSHREW_ALOLAN] =
    {
        ...
        .abilities = {ABILITY_PROTOSYNTHESIS, ABILITY_GRIM_NEIGH, ABILITY_SHEER_FORCE}
        .bodyColor = BODY_COLOR_BLUE,
        .height = 7,
        .weight = 400,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SANDSLASH_ALOLAN] =
    {
        ...
        .baseSpDefense = 65,
        .types = { TYPE_ICE, TYPE_STEEL },
        .abilities = {ABILITY_OBLIVIOUS, ABILITY_SOLAR_POWER, ABILITY_OWN_TEMPO}
        .bodyColor = BODY_COLOR_BLUE,
        .height = 12,
        .weight = 550,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_NIDORAN_F] =
    {
        ...
        .abilities = {ABILITY_QUARK_DRIVE, ABILITY_ELECTRIC_SURGE, ABILITY_MAGICIAN}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NIDORINA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_RIPEN, ABILITY_VITAL_SPIRIT, ABILITY_SERENE_GRACE}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NIDOQUEEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_STEADFAST, ABILITY_GALE_WINGS, ABILITY_BERSERK}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NIDORAN_M] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_FIELD },
        .abilities = {ABILITY_EMBODY_ASPECT_HEARTHFLAME, ABILITY_SKILL_LINK, ABILITY_AURA_BREAK}
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Nidoran♂"),
        .cryId = CRY_NIDORAN_M,
    ...
    [SPECIES_NIDORINO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_FIELD },
        .abilities = {ABILITY_HONEY_GATHER, ABILITY_POWER_OF_ALCHEMY, ABILITY_GRIM_NEIGH}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_NIDOKING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_FIELD },
        .abilities = {ABILITY_STRONG_JAW, ABILITY_MINUS, ABILITY_POISON_TOUCH}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_LIBERO, ABILITY_ELECTROMORPHOSIS, ABILITY_WHITE_SMOKE}
    ...
    [SPECIES_CLEFAIRY] =
    {
        ...
        .abilities = {ABILITY_INNER_FOCUS, ABILITY_COMATOSE, ABILITY_RECEIVER}
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_FAIRY, EGG_GROUP_FAIRY },
        .abilities = {ABILITY_ROUGH_SKIN, ABILITY_ANGER_POINT, ABILITY_TOXIC_DEBRIS}
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
...
#define NINETALES_MISC_INFO                                 \
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .abilities = {ABILITY_SOLAR_POWER, ABILITY_GUTS, ABILITY_CORROSION}
        .bodyColor = BODY_COLOR_BROWN,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_NINETALES] =
    {
        ...
        .types = { TYPE_FIRE, TYPE_FIRE },
        .itemRare = ITEM_CHARCOAL,
        .abilities = {ABILITY_STEELY_SPIRIT, ABILITY_CHLOROPHYLL, ABILITY_RECEIVER}
        .bodyColor = BODY_COLOR_YELLOW,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_VULPIX_ALOLAN] =
    {
        ...
        .abilities = {ABILITY_TERAVOLT, ABILITY_COSTAR, ABILITY_ARENA_TRAP}
        .bodyColor = BODY_COLOR_BLUE,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_NINETALES_ALOLAN] =
    {
        ...
        .itemRare = ITEM_SNOWBALL,
        .abilities = {ABILITY_JUSTIFIED, ABILITY_DAMP, ABILITY_PRESSURE}
        .bodyColor = BODY_COLOR_BLUE,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_IGGLYBUFF] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_REGENERATOR, ABILITY_SERENE_GRACE, ABILITY_DRY_SKIN}
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_JIGGLYPUFF] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_FAIRY, EGG_GROUP_FAIRY },
        .abilities = {ABILITY_ICE_BODY, ABILITY_ANGER_SHELL, ABILITY_MINDS_EYE}
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_WIGGLYTUFF] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_FAIRY, EGG_GROUP_FAIRY },
        .abilities = {ABILITY_STEELWORKER, ABILITY_NEUROFORCE, ABILITY_STEADFAST}
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = {ABILITY_CHILLING_NEIGH, ABILITY_HARVEST, ABILITY_EARLY_BIRD}
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Zubat"),
        .cryId = CRY_ZUBAT,
    ...
    [SPECIES_GOLBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = {ABILITY_EMBODY_ASPECT_WELLSPRING, ABILITY_CHILLING_NEIGH, ABILITY_DEFEATIST}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CROBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = {ABILITY_COMMANDER, ABILITY_SEED_SOWER, ABILITY_REFRIGERATE}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .abilities = {ABILITY_RAIN_DISH, ABILITY_RECKLESS, ABILITY_ILLUSION}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GLOOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = {ABILITY_DOWNLOAD, ABILITY_HUSTLE, ABILITY_ICE_SCALES}
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gloom"),
        .cryId = CRY_GLOOM,
    ...
    [SPECIES_VILEPLUME] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = {ABILITY_JUSTIFIED, ABILITY_PRESSURE, ABILITY_OPPORTUNIST}
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BELLOSSOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = {ABILITY_FLARE_BOOST, ABILITY_MULTISCALE, ABILITY_RIVALRY}
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_PARAS] =
    {
        ...
        .abilities = {ABILITY_MOTOR_DRIVE, ABILITY_LIQUID_OOZE, ABILITY_UNSEEN_FIST}
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Paras"),
        .cryId = CRY_PARAS,
    ...
    [SPECIES_PARASECT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_GRASS },
        .abilities = {ABILITY_BEAST_BOOST, ABILITY_STEELWORKER, ABILITY_GALVANIZE}
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_VENONAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = {ABILITY_SERENE_GRACE, ABILITY_MAGIC_GUARD, ABILITY_POWER_OF_ALCHEMY}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_VENOMOTH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = {ABILITY_LIQUID_VOICE, ABILITY_OVERCOAT, ABILITY_ICE_BODY}
        .bodyColor = BODY_COLOR_PURPLE,
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 100 : 80)
    ...
    [SPECIES_DIGLETT] =
    {
        ...
        .baseSpDefense = 45,
        .types = { TYPE_GROUND, TYPE_GROUND },
        .abilities = {ABILITY_POISON_TOUCH, ABILITY_SHED_SKIN, ABILITY_BATTERY}
        .weight = 8,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_DUGTRIO] =
    {
        ...
        .baseSpDefense = 70,
        .types = { TYPE_GROUND, TYPE_GROUND },
        .abilities = {ABILITY_PICKUP, ABILITY_MIMICRY, ABILITY_WIND_POWER}
        .weight = 333,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_DIGLETT_ALOLAN] =
    {
        ...
        .abilities = {ABILITY_MULTITYPE, ABILITY_PICKPOCKET, ABILITY_ICE_SCALES}
        .weight = 10,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_DUGTRIO_ALOLAN] =
    {
        ...
        .baseSpDefense = 70,
        .types = { TYPE_GROUND, TYPE_STEEL },
        .abilities = {ABILITY_RUN_AWAY, ABILITY_QUEENLY_MAJESTY, ABILITY_POWER_CONSTRUCT}
        .noFlip = TRUE,
        .weight = 666,
        .description = COMPOUND_STRING(
...
#define PERSIAN_MISC_INFO                                   \
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .types = { TYPE_NORMAL, TYPE_NORMAL },
        .itemRare = ITEM_QUICK_CLAW,
        .abilities = {ABILITY_SPEED_BOOST, ABILITY_RIPEN, ABILITY_COSTAR}
        .bodyColor = BODY_COLOR_YELLOW,
        .height = 4,
        .weight = 42,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .baseSpDefense = 65,
        .types = { TYPE_NORMAL, TYPE_NORMAL },
        .abilities = {ABILITY_ROUGH_SKIN, ABILITY_CHILLING_NEIGH, ABILITY_VICTORY_STAR}
        .bodyColor = BODY_COLOR_YELLOW,
        .height = 10,
        .weight = 320,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MEOWTH_ALOLAN] =
    {
        ...
        .itemRare = ITEM_QUICK_CLAW,
        .abilities = {ABILITY_ROCKY_PAYLOAD, ABILITY_SURGE_SURFER, ABILITY_DANCER}
    ...
    [SPECIES_PERSIAN_ALOLAN] =
    {
        ...
        .baseSpDefense = 65,
        .types = { TYPE_DARK, TYPE_DARK },
        .abilities = {ABILITY_SPEED_BOOST, ABILITY_MERCILESS, ABILITY_IMPOSTER}
        .bodyColor = BODY_COLOR_GRAY,
        .height = 11,
        .weight = 330,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MEOWTH_GALARIAN] =
    {
        ...
        .abilities = {ABILITY_SHARPNESS, ABILITY_RAIN_DISH, ABILITY_SAP_SIPPER}
        .bodyColor = BODY_COLOR_BROWN,
        .height = 4,
        .weight = 75,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_PERRSERKER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_GORILLA_TACTICS, ABILITY_ROCKY_PAYLOAD, ABILITY_MYCELIUM_MIGHT}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_MEOWTH_GIGANTAMAX] =
    {
        ...
        .types = { TYPE_NORMAL, TYPE_NORMAL },
        .itemRare = ITEM_QUICK_CLAW,
        .abilities = {ABILITY_INFILTRATOR, ABILITY_CUTE_CHARM, ABILITY_VESSEL_OF_RUIN}
        .bodyColor = BODY_COLOR_YELLOW,
        .height = 330,
        .weight = 0,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_PSYDUCK] =
    {
        ...
        .abilities = {ABILITY_ZERO_TO_HERO, ABILITY_WIMP_OUT, ABILITY_DESOLATE_LAND}
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GOLDUCK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_FIELD },
        .abilities = {ABILITY_FLOWER_VEIL, ABILITY_MAGIC_BOUNCE, ABILITY_RAIN_DISH}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_DESOLATE_LAND, ABILITY_AS_ONE_ICE_RIDER, ABILITY_WONDER_SKIN}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PRIMEAPE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_EFFECT_SPORE, ABILITY_DEFEATIST, ABILITY_PURE_POWER}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_ANNIHILAPE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_CORROSION, ABILITY_THERMAL_EXCHANGE, ABILITY_SUPREME_OVERLORD}
        .bodyColor = BODY_COLOR_GRAY,
...
#define ARCANINE_MISC_INFO                                  \
    ...
    [SPECIES_GROWLITHE] =
    {
        ...
        .baseSpDefense = 50,
        .types = { TYPE_FIRE, TYPE_FIRE },
        .abilities = {ABILITY_TANGLED_FEET, ABILITY_HEALER, ABILITY_POWER_OF_ALCHEMY}
    ...
    [SPECIES_ARCANINE] =
    {
        ...
        .baseSpDefense = 80,
        .types = { TYPE_FIRE, TYPE_FIRE },
        .abilities = {ABILITY_VITAL_SPIRIT, ABILITY_BAD_DREAMS, ABILITY_BALL_FETCH}
        .height = 19,
        .weight = 1550,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_GROWLITHE_HISUIAN] =
    {
        ...
        .abilities = {ABILITY_CURIOUS_MEDICINE, ABILITY_WEAK_ARMOR, ABILITY_EFFECT_SPORE}
    ...
    [SPECIES_ARCANINE_HISUIAN] =
    {
        ...
        .baseSpDefense = 80,
        .types = { TYPE_FIRE, TYPE_ROCK },
        .abilities = {ABILITY_WATER_VEIL, ABILITY_FLARE_BOOST, ABILITY_PLUS}
        .height = 20,
        .weight = 1680,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_POLIWAG] =
    {
        ...
        .abilities = {ABILITY_INFILTRATOR, ABILITY_ROUGH_SKIN, ABILITY_WIND_RIDER}
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_POLIWHIRL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_WATER_1 },
        .abilities = {ABILITY_DISGUISE, ABILITY_POWER_OF_ALCHEMY, ABILITY_CURSED_BODY}
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_POLIWRATH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_WATER_1 },
        .abilities = {ABILITY_LEAF_GUARD, ABILITY_SPEED_BOOST, ABILITY_SOLAR_POWER}
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_POLITOED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_WATER_1 },
        .abilities = {ABILITY_HEALER, ABILITY_POWER_SPOT, ABILITY_CLEAR_BODY}
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_ABRA] =
    {
        ...
        .abilities = {ABILITY_SOLAR_POWER, ABILITY_LIQUID_VOICE, ABILITY_SLUSH_RUSH}
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Abra"),
        .cryId = CRY_ABRA,
    ...
    [SPECIES_KADABRA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_GRASS_PELT, ABILITY_GULP_MISSILE, ABILITY_RATTLED}
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
...
#define ALAKAZAM_MISC_INFO                                          \
    ...
    [SPECIES_ALAKAZAM] =
    {
        ...
        .expYield = 225,
        .abilities = {ABILITY_SYMBIOSIS, ABILITY_MAGICIAN, ABILITY_REFRIGERATE}
        .cryId = CRY_ALAKAZAM,
        .height = 15,
        .weight = 480,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_ALAKAZAM_MEGA] =
    {
        ...
        .expYield = 270,
        .abilities = {ABILITY_ANTICIPATION, ABILITY_STALWART, ABILITY_SOUNDPROOF}
    ...
    [SPECIES_MACHOP] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_DARK_AURA, ABILITY_CHEEK_POUCH, ABILITY_MULTISCALE}
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MACHOKE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_TELEPATHY, ABILITY_BERSERK, ABILITY_FLASH_FIRE}
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
...
#define MACHAMP_MISC_INFO                                                   \
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,                                   \
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },        \
        .abilities = {ABILITY_SHIELD_DUST, ABILITY_FLASH_FIRE, ABILITY_WONDER_SKIN}
        .bodyColor = BODY_COLOR_GRAY,                                       \
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = {ABILITY_FAIRY_AURA, ABILITY_UNNERVE, ABILITY_QUICK_FEET}
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WEEPINBELL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = {ABILITY_PIXILATE, ABILITY_SAND_STREAM, ABILITY_INNER_FOCUS}
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_VICTREEBEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = {ABILITY_ANGER_POINT, ABILITY_DARK_AURA, ABILITY_HYDRATION}
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TENTACOOL] =
    {
        ...
        .abilities = {ABILITY_LIGHT_METAL, ABILITY_INTREPID_SWORD, ABILITY_FAIRY_AURA}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_TENTACRUEL] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_WATER_3, EGG_GROUP_WATER_3 },
        .abilities = {ABILITY_SHARPNESS, ABILITY_SAND_RUSH, ABILITY_RUN_AWAY}
        .bodyColor = BODY_COLOR_BLUE,
...
#define KANTONIAN_GEODUDE_FAMILY_INFO                                       \
        ...
        .abilities = {ABILITY_STAMINA, ABILITY_SHIELD_DUST, ABILITY_ANGER_POINT}
...
#define ALOLAN_GEODUDE_FAMILY_INFO                                              \
        ...
        .abilities = {ABILITY_GUARD_DOG, ABILITY_LEAF_GUARD, ABILITY_POISON_TOUCH}
        .isAlolanForm = TRUE
...
#define KANTONIAN_PONYTA_FAMILY_INFO                                                \
        .types = { TYPE_FIRE, TYPE_FIRE },                                          \
        .abilities = {ABILITY_FLARE_BOOST, ABILITY_ANGER_SHELL, ABILITY_ARMOR_TAIL}
        .bodyColor = BODY_COLOR_YELLOW
...
#define GALARIAN_PONYTA_FAMILY_INFO                                                 \
        .abilities = {ABILITY_MOXIE, ABILITY_WONDER_GUARD, ABILITY_SUPREME_OVERLORD}
        .bodyColor = BODY_COLOR_WHITE,                                              \
        .isGalarianForm = TRUE
...
#define SLOWKING_MISC_INFO                                      \
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .abilities = {ABILITY_IRON_BARBS, ABILITY_COMMANDER, ABILITY_MULTISCALE}
        .cryId = CRY_SLOWPOKE,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SLOWBRO] =
    {
        ...
        .expYield = 172,
        .evYield_Defense = 2,
        .abilities = {ABILITY_AFTERMATH, ABILITY_ADAPTABILITY, ABILITY_PASTEL_VEIL}
        .height = 16,
        .weight = 785,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SLOWKING] =
    {
        ...
        .evYield_SpDefense = 3,
        .itemRare = ITEM_KINGS_ROCK,
        .abilities = {ABILITY_PRESSURE, ABILITY_DRIZZLE, ABILITY_LIBERO}
    ...
    [SPECIES_SLOWBRO_MEGA] =
    {
        ...
        .expYield = 207,
        .evYield_Defense = 2,
        .abilities = {ABILITY_ICE_FACE, ABILITY_DISGUISE, ABILITY_CORROSION}
        .height = 20,
        .weight = 1200,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SLOWPOKE_GALARIAN] =
    {
        SLOWPOKE_MISC_INFO,
        .types = { TYPE_PSYCHIC, TYPE_PSYCHIC },
        .abilities = {ABILITY_EFFECT_SPORE, ABILITY_OWN_TEMPO, ABILITY_COMATOSE}
    ...
    [SPECIES_SLOWBRO_GALARIAN] =
    {
        ...
        .expYield = 172,
        .evYield_Attack = 2,
        .abilities = {ABILITY_FLOWER_GIFT, ABILITY_SHEER_FORCE, ABILITY_GOOEY}
        .height = 16,
        .weight = 705,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SLOWKING_GALARIAN] =
    {
        ...
        .types = { TYPE_POISON, TYPE_PSYCHIC },
        .evYield_SpDefense = 2,
        .abilities = {ABILITY_SWARM, ABILITY_EMBODY_ASPECT_TEAL, ABILITY_PRESSURE}
    ...
    [SPECIES_MAGNEMITE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },
        .abilities = {ABILITY_HUGE_POWER, ABILITY_QUARK_DRIVE, ABILITY_POWER_OF_ALCHEMY}
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MAGNETON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },
        .abilities = {ABILITY_QUEENLY_MAJESTY, ABILITY_ICE_SCALES, ABILITY_EMBODY_ASPECT_CORNERSTONE}
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MAGNEZONE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },
        .abilities = {ABILITY_RIPEN, ABILITY_HEATPROOF, ABILITY_SUCTION_CUPS}
        .bodyColor = BODY_COLOR_GRAY,
...
#define FARFETCHD_MISC_INFO                                 \
    ...
    [SPECIES_FARFETCHD] =
    {
        ...
        .types = { TYPE_NORMAL, TYPE_FLYING },
        .itemRare = ITEM_LEEK,
        .abilities = {ABILITY_MOODY, ABILITY_EMERGENCY_EXIT, ABILITY_SYMBIOSIS}
        .height = 8,
        .weight = 150,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_FARFETCHD_GALARIAN] =
    {
        ...
        .abilities = {ABILITY_QUEENLY_MAJESTY, ABILITY_FLARE_BOOST, ABILITY_SUCTION_CUPS}
        .height = 8,
        .weight = 420,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SIRFETCHD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FIELD },
        .abilities = {ABILITY_SNOW_CLOAK, ABILITY_INSOMNIA, ABILITY_DELTA_STREAM}
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_DODUO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = {ABILITY_LIBERO, ABILITY_COTTON_DOWN, ABILITY_SHARPNESS}
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Doduo"),
        .cryId = CRY_DODUO,
    ...
    [SPECIES_DODRIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = {ABILITY_DRY_SKIN, ABILITY_STAKEOUT, ABILITY_MYCELIUM_MIGHT}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SEEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_FIELD },
        .abilities = {ABILITY_QUICK_FEET, ABILITY_PRESSURE, ABILITY_BATTLE_BOND}
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Seel"),
        .cryId = CRY_SEEL,
    ...
    [SPECIES_DEWGONG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_FIELD },
        .abilities = {ABILITY_CLEAR_BODY, ABILITY_PARENTAL_BOND, ABILITY_FORECAST}
        .bodyColor = BODY_COLOR_WHITE,
...
#define KANTONIAN_GRIMER_FAMILY_INFO                                                \
        .types = { TYPE_POISON, TYPE_POISON },                                      \
        .abilities = {ABILITY_LIBERO, ABILITY_RATTLED, ABILITY_NEUTRALIZING_GAS}
        .bodyColor = BODY_COLOR_PURPLE
...
#define ALOLAN_GRIMER_FAMILY_INFO                                                           \
        ...
        .abilities = {ABILITY_EARTH_EATER, ABILITY_KLUTZ, ABILITY_MISTY_SURGE}
        .bodyColor = BODY_COLOR_GREEN,                                                      \
        .isAlolanForm = TRUE
    ...
    [SPECIES_SHELLDER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_WATER_3, EGG_GROUP_WATER_3 },
        .abilities = {ABILITY_DEFEATIST, ABILITY_DRIZZLE, ABILITY_MOXIE}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CLOYSTER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_WATER_3, EGG_GROUP_WATER_3 },
        .abilities = {ABILITY_INTIMIDATE, ABILITY_ZEN_MODE, ABILITY_ICE_SCALES}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS },
        .abilities = {ABILITY_IMMUNITY, ABILITY_SAND_SPIT}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_HAUNTER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_AMORPHOUS, EGG_GROUP_AMORPHOUS },
        .abilities = {ABILITY_STRONG_JAW, ABILITY_PSYCHIC_SURGE}
        .bodyColor = BODY_COLOR_PURPLE,
...
#define GENGAR_MISC_INFO                                            \
    ...
    [SPECIES_GENGAR_MEGA] =
    {
        ...
        .baseSpDefense = 95,
        .expYield = 270,
        .abilities = {ABILITY_WELL_BAKED_BODY, ABILITY_WATER_ABSORB, ABILITY_TOXIC_BOOST}
        .isMegaEvolution = TRUE,
        .height = 14,
        .weight = 405,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_ONIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },
        .abilities = {ABILITY_STALWART, ABILITY_SYNCHRONIZE, ABILITY_WHITE_SMOKE}
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Onix"),
        .cryId = CRY_ONIX,
...
#define STEELIX_MISC_INFO                                       \
    ...
    [SPECIES_STEELIX] =
    {
        ...
        .baseSpDefense = 65,
        .expYield = 179,
        .abilities = {ABILITY_ANGER_POINT, ABILITY_BALL_FETCH, ABILITY_OVERCOAT}
        .cryId = CRY_STEELIX,
        .height = 92,
        .weight = 4000,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_STEELIX_MEGA] =
    {
        ...
        .baseSpDefense = 95,
        .expYield = 214,
        .abilities = {ABILITY_CLOUD_NINE, ABILITY_ILLUSION, ABILITY_DESOLATE_LAND}
    ...
    [SPECIES_DROWZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_IMMUNITY, ABILITY_SWIFT_SWIM, ABILITY_IMPOSTER}
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_HYPNO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_BAD_DREAMS, ABILITY_FORECAST, ABILITY_MOTOR_DRIVE}
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Hypno"),
        .cryId = CRY_HYPNO,
    ...
    [SPECIES_KRABBY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_WATER_3, EGG_GROUP_WATER_3 },
        .abilities = {ABILITY_CURIOUS_MEDICINE, ABILITY_HOSPITALITY, ABILITY_DISGUISE}
        .bodyColor = BODY_COLOR_RED,
...
#define KINGLER_MISC_INFO                                                               \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                               \
        .eggGroups = { EGG_GROUP_WATER_3, EGG_GROUP_WATER_3 },                          \
        .abilities = {ABILITY_GULP_MISSILE, ABILITY_EARLY_BIRD, ABILITY_SAP_SIPPER}
        .bodyColor = BODY_COLOR_RED,                                                    \
        .noFlip = TRUE,                                                                 \
...
#define VOLTORB_FAMILY_MISC_INFO                                                \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                       \
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },                  \
        .abilities = {ABILITY_SHIELDS_DOWN, ABILITY_DESOLATE_LAND, ABILITY_PURE_POWER}
        .bodyColor = BODY_COLOR_RED
...
#define ELECTRODE_MISC_INFO                                     \
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = {ABILITY_FULL_METAL_BODY, ABILITY_WONDER_GUARD, ABILITY_WEAK_ARMOR}
        .bodyColor = BODY_COLOR_PINK,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_EXEGGUTOR] =
    {
        ...
        .types = { TYPE_GRASS, TYPE_PSYCHIC },
        .abilities = {ABILITY_PSYCHIC_SURGE, ABILITY_COSTAR, ABILITY_WIND_RIDER}
        .height = 20,
        .weight = 1200,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_EXEGGUTOR_ALOLAN] =
    {
        ...
        .abilities = {ABILITY_STEADFAST, ABILITY_COLOR_CHANGE, ABILITY_ELECTRIC_SURGE}
        .height = 109,
        .weight = 4156,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .abilities = {ABILITY_DEFEATIST, ABILITY_MARVEL_SCALE, ABILITY_DRAGONS_MAW}
        .bodyColor = BODY_COLOR_BROWN,
...
#define MAROWAK_MISC_INFO                                       \
    ...
    [SPECIES_MAROWAK] =
    {
        MAROWAK_MISC_INFO,
        .types = { TYPE_GROUND, TYPE_GROUND },
        .abilities = {ABILITY_SAP_SIPPER, ABILITY_DROUGHT, ABILITY_RUN_AWAY}
        .bodyColor = BODY_COLOR_BROWN,
        .weight = 450,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MAROWAK_ALOLAN] =
    {
        ...
        .abilities = {ABILITY_SUPER_LUCK, ABILITY_INSOMNIA, ABILITY_HEALER}
        .bodyColor = BODY_COLOR_PURPLE,
        .weight = 340,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_TYROGUE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_SURGE_SURFER, ABILITY_ZERO_TO_HERO, ABILITY_CONTRARY}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_HITMONLEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_TERAVOLT, ABILITY_SHEER_FORCE, ABILITY_GULP_MISSILE}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HITMONCHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_WATER_ABSORB, ABILITY_LINGERING_AROMA, ABILITY_DAZZLING}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HITMONTOP] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_SWORD_OF_RUIN, ABILITY_SCREEN_CLEANER, ABILITY_VESSEL_OF_RUIN}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LICKITUNG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_MONSTER },
        .abilities = {ABILITY_DAUNTLESS_SHIELD, ABILITY_HUNGER_SWITCH, ABILITY_INNARDS_OUT}
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_LICKILICKY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_MONSTER },
        .abilities = {ABILITY_GRIM_NEIGH, ABILITY_INNARDS_OUT, ABILITY_SHIELDS_DOWN}
        .bodyColor = BODY_COLOR_PINK,
...
#define WEEZING_MISC_INFO                                           \
    ...
    [SPECIES_WEEZING_GALARIAN] =
    {
        ...
        .abilities = {ABILITY_SHADOW_SHIELD, ABILITY_POISON_POINT, ABILITY_TOXIC_BOOST}
        .bodyColor = BODY_COLOR_GRAY,
        .isGalarianForm = TRUE,
        .height = 30,
        .weight = 160,
    ...
    [SPECIES_RHYHORN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_FIELD },
        .abilities = {ABILITY_SNOW_CLOAK, ABILITY_SERENE_GRACE, ABILITY_NEUTRALIZING_GAS}
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_RHYDON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_FIELD },
        .abilities = {ABILITY_IRON_FIST, ABILITY_ORICHALCUM_PULSE, ABILITY_TELEPATHY}
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_RHYPERIOR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_FIELD },
        .abilities = {ABILITY_COMATOSE, ABILITY_POWER_OF_ALCHEMY, ABILITY_LIQUID_OOZE}
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_HAPPINY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_STEELWORKER, ABILITY_LIMBER, ABILITY_KLUTZ}
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_CHANSEY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_FAIRY, EGG_GROUP_FAIRY },
        .abilities = {ABILITY_RKS_SYSTEM, ABILITY_MINDS_EYE, ABILITY_PRANKSTER}
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_BLISSEY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_FAIRY, EGG_GROUP_FAIRY },
        .abilities = {ABILITY_COLOR_CHANGE, ABILITY_MEGA_LAUNCHER, ABILITY_PICKUP}
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_TANGELA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = {ABILITY_UNSEEN_FIST, ABILITY_DEFEATIST, ABILITY_COLOR_CHANGE}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_TANGROWTH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = {ABILITY_PLUS, ABILITY_AIR_LOCK, ABILITY_CHEEK_POUCH}
        .bodyColor = BODY_COLOR_BLUE,
...
#define KANGASKHAN_MISC_INFO                                    \
    ...
    [SPECIES_KANGASKHAN] =
    {
        ...
        .baseSpDefense = 80,
        .expYield = 172,
        .abilities = {ABILITY_SCREEN_CLEANER, ABILITY_SNOW_WARNING, ABILITY_AURA_BREAK}
    ...
    [SPECIES_KANGASKHAN_MEGA] =
    {
        ...
        .baseSpDefense = 100,
        .expYield = 207,
        .abilities = {ABILITY_GRASS_PELT, ABILITY_SWARM, ABILITY_SCRAPPY}
        .isMegaEvolution = TRUE,
    ...
    [SPECIES_HORSEA] =
    {
        ...
        .abilities = {ABILITY_FLARE_BOOST, ABILITY_MUMMY, ABILITY_CHLOROPHYLL}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SEADRA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_DRAGON },
        .abilities = {ABILITY_INFILTRATOR, ABILITY_SNOW_WARNING, ABILITY_GRASS_PELT}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_KINGDRA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_DRAGON },
        .abilities = {ABILITY_TOXIC_DEBRIS, ABILITY_GALVANIZE, ABILITY_SURGE_SURFER}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GOLDEEN] =
    {
        ...
        .abilities = {ABILITY_TANGLING_HAIR, ABILITY_NO_GUARD, ABILITY_ARENA_TRAP}
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SEAKING] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_WATER_2, EGG_GROUP_WATER_2 },
        .abilities = {ABILITY_NO_GUARD, ABILITY_SOUNDPROOF, ABILITY_CLOUD_NINE}
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_STARYU] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_WATER_3, EGG_GROUP_WATER_3 },
        .abilities = {ABILITY_CLOUD_NINE, ABILITY_SNOW_WARNING, ABILITY_FLAME_BODY}
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_STARMIE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_WATER_3, EGG_GROUP_WATER_3 },
        .abilities = {ABILITY_TECHNICIAN, ABILITY_SAP_SIPPER, ABILITY_STRONG_JAW}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_BATTLE_ARMOR, ABILITY_STEAM_ENGINE, ABILITY_SWORD_OF_RUIN}
        .bodyColor = BODY_COLOR_PINK,
...
#define MR_MIME_MISC_INFO                                           \
    ...
    [SPECIES_MR_MIME] =
    {
        ...
        #endif
        .evYield_SpDefense = 2,
        .abilities = {ABILITY_SPEED_BOOST, ABILITY_ELECTROMORPHOSIS, ABILITY_LIQUID_OOZE}
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_MR_MIME_GALARIAN] =
    {
        ...
        .evYield_Speed = 2,
        .abilities = {ABILITY_KEEN_EYE, ABILITY_GLUTTONY, ABILITY_MAGICIAN}
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_MR_RIME] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_FLOWER_GIFT, ABILITY_NORMALIZE, ABILITY_TRANSISTOR}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = {ABILITY_AFTERMATH, ABILITY_SERENE_GRACE, ABILITY_THICK_FAT}
        .bodyColor = BODY_COLOR_GREEN,
...
#define SCIZOR_MISC_INFO                                \
    ...
    [SPECIES_SCIZOR] =
    {
        ...
        .baseSpDefense = 80,
        .expYield = 175,
        .abilities = {ABILITY_DRY_SKIN, ABILITY_CHEEK_POUCH, ABILITY_DEFEATIST}
        .cryId = CRY_SCIZOR,
        .height = 18,
        .weight = 1180,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SCIZOR_MEGA] =
    {
        ...
        .baseSpDefense = 100,
        .expYield = 210,
        .abilities = {ABILITY_HARVEST, ABILITY_COMPOUND_EYES, ABILITY_BALL_FETCH}
        .isMegaEvolution = TRUE,
    ...
    [SPECIES_KLEAVOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = {ABILITY_HUSTLE, ABILITY_ARENA_TRAP, ABILITY_MIMICRY}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SMOOCHUM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_SHEER_FORCE, ABILITY_PERISH_BODY, ABILITY_SHADOW_SHIELD}
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_JYNX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_THERMAL_EXCHANGE, ABILITY_LIMBER, ABILITY_SCRAPPY}
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Jynx"),
        .cryId = CRY_JYNX,
    ...
    [SPECIES_ELEKID] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_TERAVOLT, ABILITY_PROPELLER_TAIL, ABILITY_KLUTZ}
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
    ...
    [SPECIES_ELECTABUZZ] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_PLUS, ABILITY_WATER_ABSORB, ABILITY_CURSED_BODY}
        .bodyColor = BODY_COLOR_YELLOW,
        .noFlip = TRUE,
    ...
    [SPECIES_ELECTIVIRE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_RKS_SYSTEM, ABILITY_LEAF_GUARD, ABILITY_MAGNET_PULL}
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MAGBY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_SUPREME_OVERLORD, ABILITY_VITAL_SPIRIT, ABILITY_PRISM_ARMOR}
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Magby"),
        .cryId = CRY_MAGBY,
    ...
    [SPECIES_MAGMAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_PROPELLER_TAIL, ABILITY_STEELWORKER, ABILITY_PRESSURE}
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MAGMORTAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_HUMAN_LIKE, EGG_GROUP_HUMAN_LIKE },
        .abilities = {ABILITY_BLAZE, ABILITY_QUARK_DRIVE, ABILITY_TANGLED_FEET}
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
...
#define PINSIR_MISC_INFO                                \
    ...
    [SPECIES_PINSIR] =
    {
        ...
        .types = { TYPE_BUG, TYPE_BUG },
        .expYield = 175,
        .abilities = {ABILITY_FLUFFY, ABILITY_INNER_FOCUS, ABILITY_SAP_SIPPER}
        .cryId = CRY_PINSIR,
        .height = 15,
        .weight = 550,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_PINSIR_MEGA] =
    {
        ...
        .types = { TYPE_BUG, TYPE_FLYING },
        .expYield = 210,
        .abilities = {ABILITY_STALL, ABILITY_SEED_SOWER, ABILITY_SUPER_LUCK}
...
#define TAUROS_MISC_INFO                                    \
    ...
    [SPECIES_TAUROS] =
    {
        ...
        .evYield_Attack = 1,
        .evYield_Speed = 1,
        .abilities = {ABILITY_SUPREME_OVERLORD, ABILITY_SOLAR_POWER, ABILITY_TOUGH_CLAWS}
        .bodyColor = BODY_COLOR_BROWN,
        .weight = 884,
        .description = COMPOUND_STRING(
...
#define TAUROS_PALDEAN_MISC_INFO                                                    \
        ...
        .baseSpDefense = 70,                                                        \
        .evYield_Attack = 2,                                                        \
        .abilities = {ABILITY_HUNGER_SWITCH, ABILITY_BALL_FETCH, ABILITY_LIQUID_OOZE}
        .bodyColor = BODY_COLOR_BLACK,                                              \
    ...
    [SPECIES_MAGIKARP] =
    {
        ...
        .abilities = {ABILITY_COLOR_CHANGE, ABILITY_RATTLED, ABILITY_MINUS}
        .bodyColor = BODY_COLOR_RED,
...
#define GYARADOS_MISC_INFO                                  \
    ...
    [SPECIES_GYARADOS] =
    {
        ...
        .expYield = 189,
        .abilities = {ABILITY_ANALYTIC, ABILITY_LEAF_GUARD, ABILITY_FLARE_BOOST}
        .cryId = CRY_GYARADOS,
        .weight = 2350,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_GYARADOS_MEGA] =
    {
        ...
        .expYield = 224,
        .abilities = {ABILITY_INTREPID_SWORD, ABILITY_TABLETS_OF_RUIN, ABILITY_CHEEK_POUCH}
...
#define LAPRAS_MISC_INFO                                                                \
        ...
        .growthRate = GROWTH_SLOW,                                                      \
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_WATER_1 },                          \
        .abilities = {ABILITY_SCREEN_CLEANER, ABILITY_SNIPER, ABILITY_BAD_DREAMS}
        .bodyColor = BODY_COLOR_BLUE,                                                   \
    ...
    [SPECIES_DITTO] =
    {
        ...
        .abilities = {ABILITY_HYDRATION, ABILITY_FILTER, ABILITY_TOXIC_CHAIN}
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Ditto"),
        .cryId = CRY_DITTO,
...
#define EEVEE_MISC_INFO                                                                 \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                               \
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },                              \
        .abilities = {ABILITY_SAND_SPIT, ABILITY_GRASSY_SURGE, ABILITY_MOODY}
        .bodyColor = BODY_COLOR_BROWN,                                                  \
        .speciesName = _("Eevee"),                                                      \
        .cryId = CRY_EEVEE,                                                             \
    ...
    [SPECIES_VAPOREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_GULP_MISSILE, ABILITY_SNOW_WARNING, ABILITY_HUNGER_SWITCH}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_JOLTEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_VITAL_SPIRIT, ABILITY_STORM_DRAIN, ABILITY_THERMAL_EXCHANGE}
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_CURSED_BODY, ABILITY_EARTH_EATER, ABILITY_STATIC}
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_JUSTIFIED, ABILITY_KEEN_EYE, ABILITY_LEVITATE}
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_UMBREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_HEAVY_METAL, ABILITY_STEELY_SPIRIT, ABILITY_INNARDS_OUT}
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_LEAFEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_SWEET_VEIL, ABILITY_NEUTRALIZING_GAS, ABILITY_GRIM_NEIGH}
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_GLACEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_CUTE_CHARM, ABILITY_DARK_AURA, ABILITY_BULLETPROOF}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SYLVEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = {ABILITY_SYNCHRONIZE, ABILITY_SWARM, ABILITY_IMMUNITY}
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_PORYGON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },
        .abilities = {ABILITY_UNSEEN_FIST, ABILITY_ICE_SCALES, ABILITY_STEELWORKER}
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_PORYGON2] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },
        .abilities = {ABILITY_HEAVY_METAL, ABILITY_OPPORTUNIST, ABILITY_MULTITYPE}
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_PORYGON_Z] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },
        .abilities = {ABILITY_PURE_POWER, ABILITY_POISON_POINT, ABILITY_RUN_AWAY}
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_OMANYTE] =
    {
        ...
        .abilities = {ABILITY_MAGIC_GUARD, ABILITY_AROMA_VEIL, ABILITY_FAIRY_AURA}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_OMASTAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_WATER_3 },
        .abilities = {ABILITY_STAKEOUT, ABILITY_DROUGHT, ABILITY_BLAZE}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_KABUTO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_WATER_3 },
        .abilities = {ABILITY_STORM_DRAIN, ABILITY_BEADS_OF_RUIN, ABILITY_THERMAL_EXCHANGE}
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_KABUTOPS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_WATER_3 },
        .abilities = {ABILITY_ANGER_POINT, ABILITY_BERSERK, ABILITY_PURIFYING_SALT}
        .bodyColor = BODY_COLOR_BROWN,
...
#define AERODACTYL_MISC_INFO                                \
    ...
    [SPECIES_AERODACTYL] =
    {
        ...
        .baseSpDefense = 75,
        .expYield = 180,
        .abilities = {ABILITY_BLAZE, ABILITY_DELTA_STREAM, ABILITY_STALL}
    ...
    [SPECIES_AERODACTYL_MEGA] =
    {
        ...
        .baseSpDefense = 95,
        .expYield = 215,
        .abilities = {ABILITY_FLASH_FIRE, ABILITY_UNBURDEN, ABILITY_FLAME_BODY}
    ...
    [SPECIES_MUNCHLAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_SYNCHRONIZE, ABILITY_ILLUMINATE, ABILITY_CORROSION}
        .bodyColor = BODY_COLOR_BLACK,
...
#define SNORLAX_MISC_INFO                                                       \
        ...
        .growthRate = GROWTH_SLOW,                                              \
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_MONSTER },                  \
        .abilities = {ABILITY_STEAM_ENGINE, ABILITY_TINTED_LENS, ABILITY_NO_GUARD}
        .bodyColor = BODY_COLOR_BLACK,                                          \
...
#define ARTICUNO_MISC_INFO                                              \
    ...
    [SPECIES_ARTICUNO] =
    {
        ...
        .evYield_SpDefense = 3,
        .eggCycles = 80,
        .abilities = {ABILITY_LONG_REACH, ABILITY_TOUGH_CLAWS, ABILITY_VOLT_ABSORB}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ARTICUNO_GALARIAN] =
    {
        ...
        .evYield_SpAttack = 3,
        .eggCycles = 120,
        .abilities = {ABILITY_SKILL_LINK, ABILITY_ROUGH_SKIN, ABILITY_UNBURDEN}
        .bodyColor = BODY_COLOR_PURPLE,
...
#define ZAPDOS_MISC_INFO                                                \
    ...
    [SPECIES_ZAPDOS_GALARIAN] =
    {
        ...
        .evYield_Attack = 3,
        .eggCycles = 120,
        .abilities = {ABILITY_STRONG_JAW, ABILITY_WATER_VEIL, ABILITY_LIMBER}
...
#define MOLTRES_MISC_INFO                                               \
    ...
    [SPECIES_MOLTRES] =
    {
        ...
        .evYield_SpAttack = 3,
        .eggCycles = 80,
        .abilities = {ABILITY_CLOUD_NINE, ABILITY_FUR_COAT, ABILITY_KLUTZ}
        .bodyColor = BODY_COLOR_YELLOW,
        .categoryName = _("Flame"),
        .weight = 600,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MOLTRES_GALARIAN] =
    {
        ...
        .evYield_SpDefense = 3,
        .eggCycles = 120,
        .abilities = {ABILITY_UNSEEN_FIST, ABILITY_SURGE_SURFER, ABILITY_STRONG_JAW}
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_DRATINI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_DRAGON },
        .abilities = {ABILITY_REFRIGERATE, ABILITY_MAGNET_PULL, ABILITY_BULLETPROOF}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DRAGONAIR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_DRAGON },
        .abilities = {ABILITY_MERCILESS, ABILITY_STURDY, ABILITY_SHIELDS_DOWN}
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DRAGONITE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_WATER_1, EGG_GROUP_DRAGON },
        .abilities = {ABILITY_SHED_SKIN, ABILITY_STEAM_ENGINE, ABILITY_SUPREME_OVERLORD}
        .bodyColor = BODY_COLOR_BROWN,
...
#define SPECIES_MEWTWO_MISC_INFO                                        \
    ...
    [SPECIES_MEWTWO] =
    {
        ...
        .types = { TYPE_PSYCHIC, TYPE_PSYCHIC },
        .expYield = 306,
        .abilities = {ABILITY_STATIC, ABILITY_WATER_COMPACTION, ABILITY_INTIMIDATE}
        .cryId = CRY_MEWTWO,
        .height = 20,
        .weight = 1220,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MEWTWO_MEGA_X] =
    {
        ...
        .expYield = 351,
        .abilities = {ABILITY_TELEPATHY, ABILITY_DEFIANT, ABILITY_PSYCHIC_SURGE}
        .isMegaEvolution = TRUE,
    ...
    [SPECIES_MEWTWO_MEGA_Y] =
    {
        ...
        .types = { TYPE_PSYCHIC, TYPE_PSYCHIC },
        .expYield = 351,
        .abilities = {ABILITY_STRONG_JAW, ABILITY_LEAF_GUARD, ABILITY_DAMP}
        .isMegaEvolution = TRUE,
    ...
    [SPECIES_MEW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_NO_EGGS_DISCOVERED, EGG_GROUP_NO_EGGS_DISCOVERED },
        .abilities = {ABILITY_JUSTIFIED, ABILITY_ANTICIPATION}
        .bodyColor = BODY_COLOR_PINK,
        .isMythical = TRUE,
        .speciesName = _("Mew"),
        .cryId = CRY_MEW,
